...
extern "C" {
    ...
    #define CBITCOIN_ERROR_INVALID_TRANSACTION 13
    ...
    #define CBITCOIN_ERROR_SIGNING_FAILED 18
    #define CBITCOIN_ERROR_INVALID_DERIVATION 19
    #define CBITCOIN_ERROR_NO_RANDOM_NUMBER_SOURCE 20
